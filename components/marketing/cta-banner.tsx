      ...
      <div className="relative mx-auto max-w-4xl px-6 py-16 text-center sm:py-20">
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full px-8 py-3.5 text-sm font-semibold text-on-gold transition-all duration-300 hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-accent focus-visible:ring-offset-2 focus-visible:ring-offset-purple-dark"
            style={{
              background: "#C5A556",
