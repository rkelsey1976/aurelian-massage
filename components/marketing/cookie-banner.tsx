      ...
      >
        ...
        <div className="mt-5 flex flex-col gap-3 sm:mt-6 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end sm:gap-3">
          ...
          <button
            ...
            className="order-1 w-full rounded-full px-5 py-3 text-sm font-semibold text-on-gold transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-accent focus-visible:ring-offset-2 focus-visible:ring-offset-[#2C1E42] sm:order-2 sm:w-auto"
            style={{
              background: "#C5A556",
