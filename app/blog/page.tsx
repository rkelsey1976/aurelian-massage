          ...
          <div className="mb-10">
            ...
            >
              ...
              <div className="flex flex-col justify-center p-8 lg:p-10">
                ...
                <Link
                  href={`/blog/${featured.slug}`}
                  className="mt-7 inline-flex w-fit items-center gap-2 rounded-full px-6 py-2.5 text-xs font-semibold uppercase tracking-[0.15em] text-purple-dark transition-all duration-200 hover:scale-105 hover:brightness-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-accent"
