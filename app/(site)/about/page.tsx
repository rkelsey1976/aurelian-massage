    ...
    <>
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1fr] lg:items-center">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <Link
                href="/treatments"
                className="inline-flex items-center gap-2 rounded-full px-7 py-3 text-sm font-semibold text-on-gold transition-all duration-300 hover:scale-105 hover:brightness-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-accent"
      ...
      <div className="mx-auto max-w-6xl px-6 py-16 text-center">
        ...
        <Link
          ...
          className="mt-8 inline-flex items-center gap-2 rounded-full px-8 py-3.5 text-sm font-semibold text-on-gold transition-all duration-300 hover:scale-105 hover:brightness-110 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold-accent"
