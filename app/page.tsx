  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6 py-16">
      ...
      <div className="relative z-10 flex w-full max-w-3xl flex-col items-center text-center">
        ...
        {/* Logo */}
        <Link href="/" aria-label={`${siteConfig.name} — Home`} className="mb-6">
          <Image
            src="/logo.svg"
        ...
        {/* Eyebrow */}
        <p className="mb-3 text-xs font-semibold uppercase tracking-[0.35em] text-gold-accent/70">
        ...
        {/* Tagline */}
        <p className="mt-4 font-serif text-lg font-light italic leading-relaxed text-neutral-mid/70 sm:text-xl">
